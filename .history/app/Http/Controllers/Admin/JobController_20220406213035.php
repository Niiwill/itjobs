...
class JobController extends Controller
{
    ...
    {   
        $jobs = Job::with(['company:id,name', 'category'])->select('id', 'title','company_id', 'category_id', 'expired_at', 'slug', 'status')->get();
        return view('admin/index');
        return view('admin/index')->with('categories',$categories)->with('tags',$tags)->with('companies',$companies)->with('cities',$cities);
