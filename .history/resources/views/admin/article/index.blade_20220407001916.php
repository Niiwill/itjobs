            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.companies.create') }}" class="btn btn-primary" role="button">Nova Kompanija</a>
                        </div>
                    </div>
                </div>
            </div>
                          ...
                          <tbody>
                            @foreach ($articles as $article)
                             ...
                             <tr>
                                ...
                                <td>
                                    @if ($article->article_category_id === 1)
                                    <a class="btn btn-warning" href="{{ route('articles.single', [$article->id, $article->slug]) }}">Link</a></td>
                                    @else
                                    <a class="btn btn-warning" href="{{ route('articles.single', ['id' => $article->id, 'slug' => $article->slug])}}">Link</a></td>
