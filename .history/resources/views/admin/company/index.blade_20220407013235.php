                          ...
                          <tbody>
                            @foreach ($companies as $company)
                             ...
                             <tr>
                                ...
                                <td>
                                    <div>
                                        <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('admin.companies.edit', $company->id) }}">
