                ...
                <div class="card">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-action">
                            <a href="{{ route('admin.jobs.create') }}" class="btn btn-primary d-flex" role="button">
                             ...
                             <tr>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('admin.jobs.edit', $job->id)}}">
                                           <span class="btn-inner">
