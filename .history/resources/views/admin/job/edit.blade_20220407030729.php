                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.jobs.store') }}"">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="type_id" class="form-select" id="exampleFormControlSelect1">
                                            ...
                                            <option value="1" {{$job->level_id == '1' ? "selected" : "" }}>Stalni</option>
                                            <option value="2" {{$job->level_id == '2' ? "selected" : "" }}>Honorarni</option>
                                            <option value="3" {{$job->level_id == '3' ? "selected" : "" }}>Freelance</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="text" class="form-control" id="exampleFormControlTextarea1" rows="5">{{$job->text}}</textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="expired_at" type="date" class="form-control" id="exampleInputdate" value="value="{{$job->expired_at}}">
                                    </div>
                                </div>
