            ...
            <div class="sidebar-body pt-0 data-scrollbar">
                <div class="sidebar-list">
                    ...
                    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.jobs*') || request()->routeIs('admin.index') ? 'active' : '' }}" aria-current="page" href="{{ route('admin.jobs.index') }}">
                                <i class="icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.tags*') ? 'active' : '' }}" aria-current="page" href="{{ route('admin.tags.index') }}">
                                <i class="icon">
                                ...
                                <span class="item-name">Tagovi</span>
                            </a>
                        </li>
